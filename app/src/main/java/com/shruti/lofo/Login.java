                ...
                .addOnCompleteListener(Login.this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (user != null && user.isEmailVerified()) {
                            ...
                            startActivity(intent);
                            finish(); // prevent returning to login/register after successful login
                        } else {
                            if (user != null) {
                                user.sendEmailVerification();
                            }
                            mAuth.signOut();
                            Toast.makeText(Login.this, "Please verify your @net.usj.edu.lb email. Verification link sent to your inbox.", Toast.LENGTH_LONG).show();
                        }
                    } else {
